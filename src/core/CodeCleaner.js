...
export class CodeCleaner {
    ...
    parseFile(content, filePath) {
        ...
        plugins.push(['decorators', { decoratorsBeforeExport: false }], 'classProperties', 'objectRestSpread', 'functionBind', 'exportDefaultFrom', 'exportNamespaceFrom', 'dynamicImport', 'nullishCoalescingOperator', 'optionalChaining');
    ...
    removeNodesFromContent(content, nodes) {
        if (nodes.length === 0)
            return content;
        try {
            ...
            const matchesNode = (currentNode, targetNode) => {
